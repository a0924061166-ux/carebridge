...
const highlights = [
  {
    ...
    title: "服務分類清楚",
    text: "依照實際生活情境整理服務，不用先看懂代碼，也能快速知道自己需要什麼。",
  },
  {
    icon: <Clock3 size={20} />,
    title: "更快判斷需求",
    text: "先從大方向找到適合的照護類型，再進一步確認細項內容，減少溝通成本。",
  },
  {
    icon: <HeartHandshake size={20} />,
    title: "以家庭需求為中心",
    text: "從日常照顧到專業護理，都以家屬最常遇到的真實情境來設計服務頁面。",
  },
];
...
export default function ServicesPage() {
  ...
  return (
    <div style={pageStyle}>
      <section className="services-hero" style={heroSectionStyle}>
        ...
        <div style={heroInnerStyle}>
          ...
          <div className="services-hero-grid" style={heroGridStyle}>
            <div>
              <div style={heroEyebrowStyle}>居家照護服務</div>

              <h1 className="services-hero-title" style={heroTitleStyle}>
                為你的家人
                <br />
                找到更合適的照護安排
              </h1>

              <p className="services-hero-text" style={heroTextStyle}>
                我們依照實際照護情境整理服務內容，從基本生活照護、飲食協助、外出陪同，
                到專業護理與安全看視，幫助家庭更快理解需求、選擇服務，也更安心地安排後續照護。
              </p>

              <div className="services-button-row" style={heroButtonRowStyle}>
                <Link href="/booking" style={heroPrimaryButtonStyle}>
                  立即預約服務 <ArrowRight size={16} />
                </Link>
                <a href="/#consult" style={heroSecondaryButtonStyle}>
                  免費諮詢
                </a>
              </div>
            </div>

            <div className="services-hero-card" style={heroInfoCardStyle}>
              <div style={heroInfoMiniStyle}>服務涵蓋</div>
              <div style={heroInfoTitleStyle}>六大服務分類</div>
              <div style={heroInfoTextStyle}>
                從日常活動協助到醫療照護支援，以更生活化的方式呈現內容，讓家屬更容易判斷需求。
              </div>
              ...
              <div style={heroInfoListStyle}>
                {[
                  ...
                  <div key={item} style={heroInfoListItemStyle}>
      ...
      <section className="services-section-wrap" style={sectionWrapStyle}>
        <div style={sectionHeaderStyle}>
          <div style={sectionMiniTitleStyle}>SERVICE CATEGORIES</div>
          <h2 className="services-section-title" style={sectionTitleStyle}>
            服務分類
          </h2>
          <p style={sectionTextStyle}>
            先從大方向理解照護需求，再進一步查看每一類服務中的細項內容與適用情境。
          </p>
        </div>
        ...
        <div style={servicesSectionListStyle}>
          {serviceCategories.map((service, index) => (
            <section key={service.title} id={service.id} style={{ ...serviceSectionStyle, scrollMarginTop: "100px" }}>
              <div className="service-section-header" style={serviceSectionHeaderStyle}>
                <div style={{ ...serviceSectionIconStyle, background: service.soft, color: service.accent }}>
                  {service.icon}
                </div>
                ...
                <div style={serviceSectionTextWrapStyle}>
                  <div style={serviceSectionTitleRowStyle}>
                    ...
                    <h3 className="service-category-title" style={serviceSectionTitleStyle}>
                      {service.title}
                    </h3>
                  </div>
              ...
              <div
                className={`service-items-grid service-columns-${service.columns}`}
                style={{
                  ...serviceItemsGridStyle,
                  gridTemplateColumns: `repeat(${service.columns}, minmax(0, 1fr))`,
                }}
              >
                  ...
                  >
                    <div style={serviceItemDefaultStyle}>
                      <div style={{ ...serviceItemNameStyle, display: "flex", alignItems: "center", gap: "12px" }}>
                        <div style={{ color: service.accent, opacity: 0.8, display: "flex", alignItems: "center" }}>
                          {item.icon}
                        </div>
                        <span>{item.name}</span>
                      </div>

                      <p className="service-mobile-detail" style={serviceMobileDetailStyle}>
                        {item.detail}
                      </p>
                    </div>
      ...
      <section className="support-section" style={supportSectionStyle}>
        <div style={supportInnerStyle}>
          <div style={supportHeaderStyle}>
            <div style={sectionMiniTitleStyle}>DAILY & MEDICAL SUPPORT</div>
            <h2 className="services-section-title" style={supportTitleStyle}>
              日常生活及醫療支援
            </h2>
            <p style={supportTextStyle}>
              將家屬最常詢問的照護內容整合成清單，方便快速確認是否符合目前需要。
            </p>
          </div>

          <div className="support-card" style={supportCardStyle}>
            ...
            <div style={supportCtaWrapStyle}>
              <Link href="/booking" style={supportPrimaryButtonStyle}>
                立即預約服務 <ArrowRight size={16} />
              </Link>
            </div>
          </div>
      ...
      <section className="highlight-section" style={highlightSectionStyle}>
        <div style={highlightInnerStyle}>
          <div style={sectionHeaderStyle}>
            ...
            <p style={sectionTextStyle}>
              不只是列出服務名稱，而是讓家屬更容易理解、比較並判斷真正需要的安排。
            </p>
          </div>
      ...
      <section className="cta-section" style={ctaSectionStyle}>
        <div className="services-cta-grid" style={ctaGridStyle}>
          <div className="services-cta-card" style={ctaLightCardStyle}>
            <div style={ctaMiniStyle}>FREE CONSULTATION</div>
            <h3 className="services-cta-title" style={ctaTitleDarkStyle}>
              不確定哪項服務比較適合？
            </h3>
            <p style={ctaTextDarkStyle}>
              如果你還不確定家中的照護需求屬於哪一類，可以先從免費諮詢開始，
              讓我們協助你判斷需求、了解可行的服務安排與後續流程。
            </p>
            <a href="/#consult" style={ctaGreenButtonStyle}>
              前往免費諮詢 <ArrowRight size={16} />
            </a>
          </div>

          <div className="services-cta-card" style={ctaDarkCardStyle}>
            <div style={ctaMiniLightStyle}>BOOK NOW</div>
            <h3 className="services-cta-title" style={ctaTitleLightStyle}>
              已經知道需求了？立即開始預約
            </h3>
            <p style={ctaTextLightStyle}>
              若你已有明確照護需求，可以直接前往預約申請頁，選擇指定照護者，或交由平台協助媒合合適人選。
            </p>
            <Link href="/booking" style={ctaWhiteButtonStyle}>
              立即預約申請 <ArrowRight size={16} />
            </Link>
          </div>
        </div>
      </section>
...
const pageStyle: React.CSSProperties = {
  ...
  background:
    "radial-gradient(circle at top left, rgba(16,185,129,0.08), transparent 24%), linear-gradient(180deg, #f8fafc 0%, #ffffff 42%, #ffffff 100%)",
  minHeight: "100vh",
...
const heroInfoMiniStyle: React.CSSProperties = {
  color: "#10b981",
  fontSize: "12px",
  fontWeight: 800,
  letterSpacing: "1px",
...
const heroInfoTitleStyle: React.CSSProperties = {
  marginTop: "12px",
  fontSize: "28px",
  fontWeight: 900,
  color: "#0f172a",
...
const heroInfoTextStyle: React.CSSProperties = {
  marginTop: "12px",
  color: "#64748b",
  fontSize: "15px",
  lineHeight: 1.85,
...
const heroInfoListStyle: React.CSSProperties = {
  display: "grid",
  gap: "12px",
  marginTop: "22px",
};

const heroInfoListItemStyle: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  gap: "10px",
  color: "#334155",
...
const servicesSectionListStyle: React.CSSProperties = {
  display: "flex",
  flexDirection: "column",
  gap: "40px",
};
...
const serviceSectionHeaderStyle: React.CSSProperties = {
  display: "flex",
  alignItems: "flex-start",
  gap: "16px",
};

const serviceSectionIconStyle: React.CSSProperties = {
  width: "54px",
  height: "54px",
  borderRadius: "18px",
  display: "flex",
...
const serviceSectionTextWrapStyle: React.CSSProperties = {
  flex: 1,
};

const serviceSectionTitleRowStyle: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  gap: "10px",
};

const serviceSectionTitleStyle: React.CSSProperties = {
  margin: 0,
  fontSize: "30px",
  fontWeight: 900,
  color: "#0f172a",
...
const serviceSectionSubtitleStyle: React.CSSProperties = {
  marginTop: "6px",
  color: "#64748b",
  fontSize: "14px",
  fontWeight: 700,
...
const serviceSectionSummaryStyle: React.CSSProperties = {
  marginTop: "14px",
  marginBottom: 0,
  color: "#475569",
  fontSize: "16px",
...
const serviceItemsGridStyle: React.CSSProperties = {
  display: "grid",
  gap: "20px",
};

const serviceItemCardStyle: React.CSSProperties = {
  minHeight: "190px",
  borderRadius: "24px",
  border: "1px solid rgba(226,232,240,0.95)",
...
const serviceItemDefaultStyle: React.CSSProperties = {
  padding: "24px 22px",
  height: "100%",
  display: "flex",
  flexDirection: "column",
...
const serviceItemNameStyle: React.CSSProperties = {
  fontSize: "22px",
  lineHeight: 1.45,
  fontWeight: 900,
  color: "#0f172a",
...
const serviceMobileDetailStyle: React.CSSProperties = {
  display: "none",
  margin: "14px 0 0",
  color: "#64748b",
  fontSize: "14px",
...
const serviceItemOverlayStyle: React.CSSProperties = {
  position: "absolute",
  inset: 0,
  padding: "22px 20px",
...
const serviceItemOverlayTitleStyle: React.CSSProperties = {
  fontSize: "20px",
  lineHeight: 1.4,
  fontWeight: 900,
};

const serviceItemOverlayTextStyle: React.CSSProperties = {
  marginTop: "12px",
  fontSize: "14px",
  lineHeight: 1.9,
  color: "#e2e8f0",
...
const serviceDividerStyle: React.CSSProperties = {
  marginTop: "10px",
  height: "1px",
  width: "100%",
  background:
...
const supportInnerStyle: React.CSSProperties = {
  maxWidth: "1180px",
  margin: "0 auto",
};

const supportHeaderStyle: React.CSSProperties = {
  textAlign: "center",
  maxWidth: "760px",
  margin: "0 auto 34px",
};
...
const supportCtaWrapStyle: React.CSSProperties = {
  display: "flex",
  justifyContent: "center",
  marginTop: "28px",
};

const supportPrimaryButtonStyle: React.CSSProperties = {
  display: "inline-flex",
  alignItems: "center",
  gap: "8px",
  padding: "14px 20px",
...
const highlightInnerStyle: React.CSSProperties = {
  maxWidth: "1180px",
  margin: "0 auto",
};
...
const ctaLightCardStyle: React.CSSProperties = {
  background: "rgba(255,255,255,0.9)",
  border: "1px solid rgba(226,232,240,0.9)",
  borderRadius: "34px",
  padding: "46px",
...
const ctaDarkCardStyle: React.CSSProperties = {
...
const ctaMiniLightStyle: React.CSSProperties = {
  color: "#6ee7b7",
  fontSize: "12px",
  fontWeight: 800,
  letterSpacing: "1px",
...
const ctaTitleDarkStyle: React.CSSProperties = {
  marginTop: "14px",
  marginBottom: "14px",
  fontSize: "32px",
  fontWeight: 900,
...
const ctaTitleLightStyle: React.CSSProperties = {
  marginTop: "14px",
  marginBottom: "14px",
  fontSize: "32px",
  fontWeight: 900,
...
const ctaTextDarkStyle: React.CSSProperties = {
  color: "#475569",
  fontSize: "16px",
  lineHeight: 1.85,
};

const ctaTextLightStyle: React.CSSProperties = {
  color: "#cbd5e1",
  fontSize: "16px",
  lineHeight: 1.85,
};

const ctaGreenButtonStyle: React.CSSProperties = {
  marginTop: "26px",
  display: "inline-flex",
  alignItems: "center",
  gap: "8px",
...
const ctaWhiteButtonStyle: React.CSSProperties = {
  marginTop: "26px",
  display: "inline-flex",
  alignItems: "center",
  gap: "8px",
  ...
  textDecoration: "none",
  fontWeight: 800,
  boxShadow: "0 10px 24px rgba(255,255,255,0.10)",
};