...
>
  {mobileMenuOpen ? "×" : "☰"}
            ...
            <div
  className={mobileMenuOpen ? "site-menu site-menu-open" : "site-menu"}
  style={siteMenuStyle}
>
              <nav style={navStyle}>
      ...
      <footer style={footerStyle}>
        <div style={footerContainerStyle}>
          <div className="footer-grid" style={footerTopGridStyle}>
            ...
            <div>
              ...
              <div style={footerLinkListStyle}>
                <Link href="/aboutus" style={footerLinkStyle}>關於我們</Link>
                <Link href="/services" style={footerLinkStyle}>服務項目</Link>
                <Link href="/recruit-detail" style={footerLinkStyle}>招募人員</Link>
                <Link href="/provider-profile" style={footerLinkStyle}>我們的照護人員</Link>
                <Link href="/booking" style={footerLinkStyle}>預約申請</Link>
              </div>
            </div>
          ...
          <div style={footerBottomStyle}>
            ...
            <div style={footerBottomLinksStyle}>
              <Link href="/aboutus" style={footerBottomLinkStyle}>關於我們</Link>
              <Link href="/services" style={footerBottomLinkStyle}>服務項目</Link>
              <Link href="/recruit-detail" style={footerBottomLinkStyle}>招募人員</Link>
            </div>
          </div>
        </div>
      </footer>
...
.site-menu > div:last-child button {
  flex: 1;
}
...
function AuthModal({
  ...
  return (
    <div style={modalOverlayStyle} onClick={onClose}>
      <div className="auth-modal-card" style={modalCardStyle} onClick={(e) => e.stopPropagation()}>
        <button style={modalCloseStyle} onClick={onClose} type="button">
          ×
        </button>

        <div className="auth-modal-grid" style={modalGridStyle}>
          <div className="auth-modal-left" style={modalLeftSideStyle}>
          ...
          <div className="auth-modal-right" style={modalRightSideStyle}>
            <form
              onSubmit={async (e) => {
                e.preventDefault();
                setSubmitting(true);
...
const siteMenuStyle: React.CSSProperties = {
  display: "flex",
  alignItems: "center",
  justifyContent: "space-between",
  gap: "20px",
